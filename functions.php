										...
										<?php if ( has_post_thumbnail() ) : ?>	
											...
											<div class="post-title-parent">
												...
												<div class="post-author">
													By <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo esc_attr( get_the_author() ); ?>"><?php the_author(); ?></a>&nbsp;&nbsp;<i class="fa fa-clock-o"></i> <?php the_time( 'F j, Y' ); ?>
												</div>
												<div class="entry-excerpt body-font mb-3">
											<?php
											$full_excerpt    = get_the_excerpt();
											$limited_excerpt = wordwrap( $full_excerpt, 100 );
											$limited_excerpt = explode( "\n", $limited_excerpt );
											$limited_excerpt = $limited_excerpt[0] . '...';
						...
						?>
								<div class="feat-col1 md-6">
									<article id="post-<?php the_ID(); ?>" <?php post_class( 'featured-post-item' ); ?>>
										...
										<?php
										$full_excerpt    = get_the_excerpt();
										$limited_excerpt = wordwrap( $full_excerpt, 55 );
										$limited_excerpt = explode( "\n", $limited_excerpt );
										$limited_excerpt = $limited_excerpt[0] . '...';
										echo esc_html( $limited_excerpt );
										?>
