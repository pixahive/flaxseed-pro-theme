...
get_header(); ?>
	...
	<section id="primary" class="<?php do_action('flaxseedpro_primary-width') ?> content-area">
		<header class="page-header">
			<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'flaxseed-pro' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
		</header><!-- .page-header -->
